...
- 🧑 ✅ `file` is tracked as an Env context (`:call_site`): stdlib frames inherit the caller's; user/inline frames are their own; built-ins read the active one. No post-hoc stamping of error payloads.
